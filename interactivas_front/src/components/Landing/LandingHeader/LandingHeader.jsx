...
import {registerService, loginService} from "../../../services/apiServices"
...
class Header extends Component {
    ...
    login = async (e) => {
        ...
        const responseLogin = await loginService(userData);
    ...
    register = async (e) => {
        ...
        const userData = {username: this.state.username, password: this.state.password}
        const responseRegister = await registerService(userData);
